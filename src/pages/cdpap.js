...
const Cdpap = () => {
  ...
  const schemaData = [
    ...
    // ✅ WebPage Schema (For the CDPAP Page)
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
    ...
    <div className="min-h-screen dark:bg-slate-600">
      ...
      >
        <h1 className="league-spartan text-xl font-medium md:text-3xl md:leading-10 text-justify auto-hyphen">
          Cottage Home Care Services is approved to assist you with the Consumer
          Directed Personal Assistant Program (CDPAP) and help you to start
          earning at optimum pay rates in New York City!
        </h1>
        <p className="mt-5 leading-relaxed open-sans md:text-lg text-justify auto-hyphen">
          ...
          responsibility for their own care. The flexibility of this program and
          the way in which it is administered is what makes it so unique. It
          promotes independence and gives the consumer a true sense of
