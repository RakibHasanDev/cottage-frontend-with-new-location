...
const Register = () => {
  ...
  const saveUser = (
    ...
    const user = { name, email, photoURL, chat, verify, time };
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className=" grid md:grid-cols-2   mx-auto gap-7 items-center  pb-20 dark:bg-slate-600">
        <div>
        ...
        <div>
          <div>
            <div className="flex justify-center ">
              <div className="w-full max-w-md p-8 space-y-1 rounded-xl bg-[#EBF8F9] marker:dark:text-gray-600 dark:bg-slate-800">
                ...
                >
                  <div className="space-y-1 text-sm">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 shadow-xl rounded-md dark:border-gray-700 bg-white dark:text-gray-100 focus:outline-none dark:bg-gray-400 dark:placeholder:text-gray-100"
                    />
                    {errors.name && (
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <input
                      ...
                      className="w-full shadow-xl px-4 py-2 rounded-md dark:border-gray-700 bg-white dark:text-gray-100 focus:outline-none  dark:bg-gray-400 dark:placeholder:text-gray-100"
                      required
                    />
                    {errors.email && (
                  ...
                  <div className="space-y-1 text-sm relative">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-md  shadow-xl dark:border-gray-700 bg-white dark:text-gray-100 focus:outline-none dark:bg-gray-400 dark:placeholder:text-gray-100"
                    />
                    {errors.password && (
                      <p className="text-red-600">{errors.password.message}</p>
                    )}
                    <div
                      className="flex justify-center text-xs text-red-800"
                      required
                    ></div>
                    <div
