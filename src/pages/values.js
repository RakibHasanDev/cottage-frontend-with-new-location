      ...
      <main className="dark:bg-slate-600">
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pt-20 ">
              ...
              <div className="flex flex-col max-w-md sm:flex-row">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900 dark:text-gray-100">
                    ...
                    knowing that they are receiving high-quality care in the
          ...
          <p className="mt-10 text-center text-gray-900 italic dark:text-gray-100">
            Overall,{" "}
            <span className="font-medium">Cottage Home Care Services</span>{" "}
            offer a range of values and benefits for individuals who require
