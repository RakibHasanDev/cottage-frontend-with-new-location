    ...
    <>
      ...
      <section className="lg:w-[85%] w-[95%] mx-auto pb-5 space-y-3 dark:text-gray-100">
        ...
        <div>
          ...
          <br />
          <p>
            These Terms & Conditions govern the SMS/text messaging
            communications provided by Cottage Home Care Services. By opting in,
            you agree to receive text messages from us under the terms below.
          </p>
          ...
          <br />
          <strong>2. Types of SMS Communications</strong>
          <br />
          <p>
          ...
          <p>
            <em>Example:</em> “Hi! This is a reminder for your upcoming
            appointment with Cottage Home Care at 25 Newbridge Road, Suite 302
            Hicksville, New York 11801 on [Date] at [Time]. Reply STOP to opt
            out.”
          </p>

          <br />
          <strong>3. Message Frequency</strong>
          <br />
          <p>
            Message frequency may vary. You may receive up to{" "}
            <strong>2 messages per week</strong> depending on your interactions.
          </p>

          <br />
          <strong>4. Messaging Fees</strong>
          <br />
          <p>
            Standard message and data rates may apply based on your mobile
            carrier&apos;s plan. These fees may vary for domestic and
        ...
        <p>
          ...
          affect a party&apos;s ability to exercise such right{" "}
        </p>
        <h3 className="text-lg font-semibold">Contact Us:</h3>
        <p>
          <strong>Cottage Home Care Services</strong>
          <br />
          <strong>Address:</strong> 25 Newbridge Road, Suite 302 Hicksville, New
          York 11801
          <br />
          <strong>Email:</strong>{" "}
          <a href="mailto:info@cottagehomecare.com">info@cottagehomecare.com</a>
          <br />
