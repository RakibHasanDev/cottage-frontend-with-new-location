...
const PrivacyPolicy = () => {
  return (
    <div className="dark:bg-slate-600 dark:text-white term-condition">
        ...
        <div data-custom-className="term-condition">
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <ul>
              <li>
                ...
                <a href="https://cottagehomecare.com" className="text-blue-600">
                  cottagehomecare.com
                </a>{" "}
          ...
          >
            ...
            <p>
              ...
              can find out more details by visiting the{" "}
            ...
            <ul>
              ...
              <li>
                ...
                be 100% secure, so we cannot promise or guarantee that
              ...
              <li>
                ...
                exercise your rights by contacting us directly. We will consider
          ...
          {/* Additional Sections */}
          <div className="my-3" id="infocollect" style={{ lineHeight: "1.5" }}>
            <h2 className="font-bold text-xl">
              1. What Information Do We Collect?
            </h2>
            <p>
              We collect personal information that you voluntarily provide to us
              when registering on our services or expressing an interest in
          ...
          <div className="my-3" id="infouse" style={{ lineHeight: "1.5" }}>
            ...
            <p>
              ...
              administer our services, communicate with you, and to comply with
              legal obligations.
            </p>
            <ul className="list-disc ml-5">
              ...
              <li>
                To send marketing and promotional communications (only with your
                consent)
              </li>
            </ul>
          </div>
