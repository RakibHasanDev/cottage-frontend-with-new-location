        ...
        >
          ...
          <div className="pt-5 pb-5 md:pb-[120px] font-[Roboto] flex  items-center gap-8 md:gap-0 md:space-y-0 md:space-x-7 flex-wrap">
            <a
              ...
              className="flex items-center px-6 py-3 md:px-5 md:py-4 border border-[#005f6b] dark:border-[#3A4256] dark:bg-[#3A4256] rounded-full text-white hover:bg-[#00A6B2] duration-500 bg-hov2 league-spartan overflow-hidden xl:text-xl bg-[#005f6b]"
